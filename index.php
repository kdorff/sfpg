		...
		function fillInfo(type, id)
		{
			if (!index || (type == 'img'))
			{
				...
				if (type == 'dir')
				{
					...
					echo "
					info += '</div><br>';
					info += '<strong>".sfpg_str_to_script(TEXT_LINKS)."</strong><br><a href=\"'+phpSelfLink(dirLink[id])+'\">".sfpg_str_to_script(TEXT_DIRECT_LINK_GALLERY)."</a><br><br>';
					".(TEXT_GALLERY_DOWNLOAD ? "info += '<a href=\"'+phpSelf+'?cmd=gallery_down&sfpg='+dirLink[id]+'\">".sfpg_str_to_script(TEXT_GALLERY_DOWNLOAD)."<br>(ZIP, '+dirSize[0]+')</a><br><br>';" : "")."
				}
				else if (type == 'img')
				{
					...
					info += '<a href=\"'+phpSelfLink(imgLink[id])+'\">".sfpg_str_to_script(TEXT_DIRECT_LINK_IMAGE)."</a><br>';
